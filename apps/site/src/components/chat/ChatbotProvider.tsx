...
function randomId() {
  ...
  if (!cryptoApi) {
    throw new Error("Secure crypto unavailable for chatbot session id generation");
  }
  ...
  throw new Error("Secure randomness unavailable for chatbot session id generation");
}
