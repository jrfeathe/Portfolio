...
| F1.6  | Mobile layout sweeps             | Verify hero/tech stack/audio/skim/chat on mobile; adjust columns/spacing; ensure sticky CTA behavior is sane.   | Mobile screenshots; list of fixes applied.                           |
| F1.7  | SVG slimming                     | Identify heavy SVGs and simplify/compress.                                                                      | Size deltas recorded; optimized assets committed.                    |
...
| F1.11 | CI restore                       | Get typecheck/Jest/Playwright/budgets green; update flaky tests if needed.                                      | CI pipeline green; notes on any test adjustments.                    |
