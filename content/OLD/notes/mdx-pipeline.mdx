...
Diagram rendering
- Diagram samples were removed to simplify CSP and shrink the attack surface. If a diagram is ever reintroduced, prefer a static SVG checked into the repo with a short alt description rather than a live rendering pipeline.
