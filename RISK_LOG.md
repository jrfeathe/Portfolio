...
| R2 | Recruiters experience slow load times on shared networks. | Medium | Medium | Enforce gated performance budgets (build + Lighthouse CI), pre-render critical pages, and alert on OTEL-backed Core Web Vitals. | Engineering lead | Open |
